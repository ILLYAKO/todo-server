...
exports.deleteAll = exports.deleteTodo = exports.updateTodo = exports.addTodo = exports.getTodos = void 0;
...
const deleteAll = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        yield todo_1.default.db.dropCollection("todos");
        yield todo_1.default.db.createCollection("todos");
        const allTodos = yield todo_1.default.find();
        res.status(200).json({
